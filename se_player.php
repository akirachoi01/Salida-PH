...
$default_server_url = $servers['vidsrc']['url']; // Set a default server
...
foreach ($servers as $key => $server) {
    echo "<option value='{$server['url']}'>{$server['name']}</option>";
}
echo "</select>
    </div>
<iframe src="https://vidsrc.me/" referrerpolicy="origin"></iframe>
    ...
    <script>
        function changeServer() {
            ...
            iframeElement.src = selectElement.value + '&player_ads_toggle=1';
        }
    </script>
</body>
</html>";
